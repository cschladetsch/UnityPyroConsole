namespace UIWidgets.Styles
{
	...
	public class StyleFast : IStyleDefaultValues
	{
		...
		public void ChangeStyle(Style style)
		{
			...
			SetScrollerStyle(style);
		}

		/// <summary>
		/// Set style for the scroller.
		/// </summary>
		/// <param name="style">Style.</param>
		public void SetScrollerStyle(Style style)
		{
			style.Scroller.Background = Background;
			style.Scroller.Highlight.Color = ColorBackground;
			style.Scroller.Text.Color = ColorPrimary;
			style.Scroller.Text.Font = Font;
			style.Scroller.Text.FontTMPro = FontTMPro;
		}
